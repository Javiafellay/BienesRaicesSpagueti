            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.php">
                        ...
                        <p class="informacion-meta">Escrito el:<span>20/09/2021</span>por: <span>Admin</span></p>
                        <p>
                            Consejos para construir una terraza con los mejores materiales y a un precio accesible
                        </p>
                    </a>
                </div>
            </article>
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.php">
                        ...
                        <p class="informacion-meta">Escrito el:<span>20/09/2021</span>por: <span>Admin</span></p>
                        <p>
                           Maximizar el espacio en tu hogar con esta guia, aprende a combinar muebles y colores para darle vida a u espacio
                        </p>
                    </a>
                </div>
            </article>
